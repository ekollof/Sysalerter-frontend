...
"""
    ...
    This is the primary build script for the process project. It exists to
    assist in building, maintaining, and distributing this project.
...
def target_webdist():
    ...
    manifest = [
        ...
        "index.markdown",
        "LICENSE.txt",
        join("docs", "pycon2003_lightning_talk.ppt"),
        "process.py",
        "logo.jpg",
    ]
    for src in manifest:
